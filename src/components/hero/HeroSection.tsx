    ...
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-b from-white via-water-light/5 to-water-light/10">
      ...
      <div className="container mx-auto px-4 pt-32 pb-16 relative">
        <div className="max-w-6xl mx-auto">
          {/* Titre principal avec plus d'espace en haut */}
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="text-5xl md:text-7xl font-light tracking-tight text-left mb-16"
          >
            Comment aimez-vous votre eau ?
          </motion.h1>

          {/* Icônes d'usage en grille fluide */}
          <div className="mb-24">
            <UsageIcons />
          </div>
          ...
          {/* Chiffres clés en bande horizontale */}
          <div className="mb-24">
            <KeyFigures />
          </div>
          ...
          >
            <p className="text-3xl font-light text-gray-800 leading-relaxed">
