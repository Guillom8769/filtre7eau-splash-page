...
const Index = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Hero Section - redesigned with premium Apple-like aesthetic */}
      <div 
        ref={heroRef}
        className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-water-light/10 relative overflow-hidden"
      >
        {/* Background overlay for depth */}
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1580437082423-4f0e58a2d413?q=80&w=2670')] bg-cover bg-center opacity-5"></div>
        <div className="absolute inset-0 bg-gradient-to-b from-white/0 via-white/20 to-white/60"></div>
        
        <div className="container mx-auto px-4 z-10 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Text content with staged animations */}
            <div className={`transition-all duration-1000 transform ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extralight text-water-dark tracking-tight mb-12 leading-tight">
            ...
            {/* Product image with premium floating effect */}
            <div className={`flex justify-center transition-all duration-1000 delay-200 transform ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="relative">
                ...
                <img 
                  ...
                  className="w-full max-w-md mx-auto relative z-10 drop-shadow-xl animate-float"
                />
                
                {/* ULTRA branding on product */}
